# CLAUDE — Stratégie `s90_adrian_synthesis`
...
**Source à étudier :** `synthese des VERDICT.md valides`
**Auteur / trader :** `Adrian Daetwyler`
...
```bash
python -m core.validation.causality    --strategy s90_adrian_synthesis   # R1
python -m core.validation.conformance  --strategy s90_adrian_synthesis   # R5
python -m core.backtest.anchored_wf    --strategy s90_adrian_synthesis
```
...
```
strategies/s90_adrian_synthesis/
