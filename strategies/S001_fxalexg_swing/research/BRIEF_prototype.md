# CLAUDE — Stratégie `s01_fxalexg_swing`
...
**Auteur / trader :** `fxalexg (1.3M abo)`
...
```bash
python -m core.validation.causality    --strategy s01_fxalexg_swing   # R1
python -m core.validation.conformance  --strategy s01_fxalexg_swing   # R5
python -m core.backtest.anchored_wf    --strategy s01_fxalexg_swing
```
