"""
FORWARD-TEST SCELLÉ s20 — LA LECTURE
=====================================

    python -m studies.s20_forward.report_forward
...
LES CRITÈRES NE REGARDENT QUE LE BRAS PRINCIPAL (EURUSD). Le bras
d'observation (USDJPY) est lu avec les mêmes instruments de mesure — même
...
from studies.s20_forward.run_forward import (              # noqa: E402
...
def arm_section(sym: str, params: dict, state: dict,
    ...
    if n == 0:
        ...
        if df is None:
            ...
            # marge amont pour l'ATR du témoin (14 barres H1 + confort)
...
def main() -> int:
    ...
    if state is None:
        print("Aucun état : le forward-test n'a jamais tourné "
              "(python -m studies.s20_forward.run_forward).")
        return 1
    try:
    ...
    print("=" * 88)
    print("FORWARD-TEST SCELLÉ — S020 MACD cross + filtre zéro, H1 — lecture contre "
          "PROTOCOL.md")
    print("=" * 88)
