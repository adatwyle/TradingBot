# CLAUDE — Stratégie `s02_creamer_auction`
...
**Source à étudier :** `https://www.youtube.com/watch?v=PL7LKUsCgIQ`
**Auteur / trader :** `Chris Creamer - Robbins World Cup 2026`
...
```bash
python -m core.validation.causality    --strategy s02_creamer_auction   # R1
python -m core.validation.conformance  --strategy s02_creamer_auction   # R5
python -m core.backtest.anchored_wf    --strategy s02_creamer_auction
```
...
```
strategies/s02_creamer_auction/
