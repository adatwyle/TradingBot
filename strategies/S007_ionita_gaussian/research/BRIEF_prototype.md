# CLAUDE — Stratégie `s07_ionita_gaussian`
...
**Source à étudier :** `https://www.youtube.com/watch?v=fdGCGXcDByk`
**Auteur / trader :** `Michael Ionita`
...
```bash
python -m core.validation.causality    --strategy s07_ionita_gaussian   # R1
python -m core.validation.conformance  --strategy s07_ionita_gaussian   # R5
python -m core.backtest.anchored_wf    --strategy s07_ionita_gaussian
```
...
```
strategies/s07_ionita_gaussian/
