# CLAUDE — Stratégie `s09_balke_rangebreakout`
...
**Source à étudier :** `https://www.youtube.com/@ReneBalke`
**Auteur / trader :** `Rene Balke`
...
```bash
python -m core.validation.causality    --strategy s09_balke_rangebreakout   # R1
python -m core.validation.conformance  --strategy s09_balke_rangebreakout   # R5
python -m core.backtest.anchored_wf    --strategy s09_balke_rangebreakout
```
...
```
strategies/s09_balke_rangebreakout/
