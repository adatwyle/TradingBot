# CLAUDE — Stratégie `s11_legacy_breakout`
...
**Source à étudier :** `projet TBOT 2026, historique`
**Auteur / trader :** `TBOT interne`
...
```bash
python -m core.validation.causality    --strategy s11_legacy_breakout   # R1
python -m core.validation.conformance  --strategy s11_legacy_breakout   # R5
python -m core.backtest.anchored_wf    --strategy s11_legacy_breakout
```
...
```
strategies/s11_legacy_breakout/
