# CLAUDE — Stratégie `s10_legacy_meanrev`
...
```bash
python -m core.validation.causality    --strategy s10_legacy_meanrev   # R1
python -m core.validation.conformance  --strategy s10_legacy_meanrev   # R5
python -m core.backtest.anchored_wf    --strategy s10_legacy_meanrev
```
