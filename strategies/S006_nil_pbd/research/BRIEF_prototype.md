...
**Source à étudier :** `https://www.youtube.com/watch?v=2ZmIn274eds`
**Auteur / trader :** `Patrick Nil`
...
```bash
python -m core.validation.causality    --strategy s06_nil_pbd   # R1
python -m core.validation.conformance  --strategy s06_nil_pbd   # R5
python -m core.backtest.anchored_wf    --strategy s06_nil_pbd
```
