# CLAUDE — Stratégie `s91_claude_scratch`
...
**Source à étudier :** `conception autonome`
**Auteur / trader :** `Claude Code`
...
```bash
python -m core.validation.causality    --strategy s91_claude_scratch   # R1
python -m core.validation.conformance  --strategy s91_claude_scratch   # R5
python -m core.backtest.anchored_wf    --strategy s91_claude_scratch
```
