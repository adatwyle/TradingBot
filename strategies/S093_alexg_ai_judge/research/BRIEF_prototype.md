# CLAUDE — Stratégie `s93_alexg_ai_judge`
...
**Source à étudier :** `https://www.youtube.com/@fxalexg__`
**Auteur / trader :** `fxalexg + juge IA`
...
```bash
python -m core.validation.causality    --strategy s93_alexg_ai_judge   # R1
python -m core.validation.conformance  --strategy s93_alexg_ai_judge   # R5
python -m core.backtest.anchored_wf    --strategy s93_alexg_ai_judge
```
