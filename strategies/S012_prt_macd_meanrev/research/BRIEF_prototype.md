# CLAUDE — Stratégie `s12_prt_macd_meanrev`
...
**Source à étudier :** `https://www.youtube.com/watch?v=1l7xWU-BU3w`
**Auteur / trader :** `ProRealTime blog (algo gratuit)`
...
```bash
python -m core.validation.causality    --strategy s12_prt_macd_meanrev   # R1
python -m core.validation.conformance  --strategy s12_prt_macd_meanrev   # R5
python -m core.backtest.anchored_wf    --strategy s12_prt_macd_meanrev
```
...
```
strategies/s12_prt_macd_meanrev/
