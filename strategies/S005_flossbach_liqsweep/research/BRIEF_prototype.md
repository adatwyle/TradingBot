# CLAUDE — Stratégie `s05_flossbach_liqsweep`
...
**Source à étudier :** `https://www.youtube.com/watch?v=BewBId1gbqQ`
**Auteur / trader :** `Tim Flossbach`
...
```bash
python -m core.validation.causality    --strategy s05_flossbach_liqsweep   # R1
python -m core.validation.conformance  --strategy s05_flossbach_liqsweep   # R5
python -m core.backtest.anchored_wf    --strategy s05_flossbach_liqsweep
```
...
```
strategies/s05_flossbach_liqsweep/
