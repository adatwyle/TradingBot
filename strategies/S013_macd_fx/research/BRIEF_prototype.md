...
```bash
python -m core.validation.causality    --strategy s13_macd_fx   # R1
python -m core.validation.conformance  --strategy s13_macd_fx   # R5
python -m core.backtest.anchored_wf    --strategy s13_macd_fx
```
