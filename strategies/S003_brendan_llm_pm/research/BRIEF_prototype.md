# CLAUDE — Stratégie `s03_brendan_llm_pm`
...
**Source à étudier :** `https://www.youtube.com/watch?v=RetsRS5u-8Q`
**Auteur / trader :** `Brendan (AI trading, ex-Raymond James)`
...
```bash
python -m core.validation.causality    --strategy s03_brendan_llm_pm   # R1
python -m core.validation.conformance  --strategy s03_brendan_llm_pm   # R5
python -m core.backtest.anchored_wf    --strategy s03_brendan_llm_pm
```
