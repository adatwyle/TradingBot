# CLAUDE — Stratégie `s08_markov_regime`
...
**Source à étudier :** `https://www.youtube.com/watch?v=Z-hU97WO30I`
**Auteur / trader :** `Lewis Jackson / Ran (hedge fund method)`
...
```bash
python -m core.validation.causality    --strategy s08_markov_regime   # R1
python -m core.validation.conformance  --strategy s08_markov_regime   # R5
python -m core.backtest.anchored_wf    --strategy s08_markov_regime
```
