# CLAUDE — Stratégie `s92_claudetrader`
...
**Source à étudier :** `https://www.youtube.com/watch?v=lIMu8ysJW68`
**Auteur / trader :** `AI Pathways (concept Hermes) / adaptation Claude Code`
...
```bash
python -m core.validation.causality    --strategy s92_claudetrader   # R1
python -m core.validation.conformance  --strategy s92_claudetrader   # R5
python -m core.backtest.anchored_wf    --strategy s92_claudetrader
```
