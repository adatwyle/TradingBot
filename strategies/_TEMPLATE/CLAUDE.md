# CLAUDE.md — cc-S0NN (TEMPLATE — remplacer S0NN et <slug>)

**Rôle** : Claude Code dédié à la stratégie S0NN. Développement, évaluation, amélioration, parcours de validation paper, mise en production — de CETTE stratégie uniquement.
...
- `manifest.yaml` = source unique de vérité : statut (`RESEARCH|BACKTESTED|PAPER|LIVE|RETIRED`), paires, paramètres. Multi-paires : une instance `S0NN.XXX-YYY` par paire, paramètres propres.
